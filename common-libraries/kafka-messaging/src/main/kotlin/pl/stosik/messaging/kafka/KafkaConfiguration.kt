...
import pl.stosik.messaging.kafka.base.sink.DlqPassingKafkaErrorSink
import pl.stosik.messaging.kafka.base.sink.KafkaEventConsumer
...
object KafkaConfiguration {
    ...
    context(ResourceScope) suspend fun <Value : Event> configure(
